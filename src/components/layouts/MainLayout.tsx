...
const MainLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navLinks = [
    { to: "/", label: "Home" },
    { to: import.meta.env.VITE_ACADEMY_URL || "https://tern-konnect-frontend.vercel.app/", label: "Explore Academy" },
        ...
        <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link
                  to={import.meta.env.VITE_ACADEMY_URL || "https://tern-konnect-frontend.vercel.app/"}
